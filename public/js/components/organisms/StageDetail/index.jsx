...
const miscItems = ['^メテオライト$', '^古の種火$', '^レムナンタイトの欠片$', 'の宝珠の欠片$', '^武器・防具$', '^ビーン$', '^ルーン$', '^[星月]の砂$', '^ルピ', '^精油$', '^SP$', 'の錬成粉\\((?:N|HN|R|HR|SR)(?::(?:ノーマル|エリート|ボス))?\\)$', '^アイアゲート$', '^マラカイト$', '^ロードナイト$', '^ガーネット$', '^タイガーアイ$', '^アマゾナイト$', '^ラピスラズリ$', '^レピドライト$', '^ムーンクォーツ$'];
